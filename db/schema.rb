...
ActiveRecord::Schema.define(version: 2022_11_04_074708) do
  ...
  create_table "goods", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["propose_id"], name: "index_goods_on_propose_id"
  ...
  create_table "proposes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["room_id"], name: "index_proposes_on_room_id"
    t.index ["user_id"], name: "index_proposes_on_user_id"
  end
  ...
  add_foreign_key "goods", "proposes"
  add_foreign_key "goods", "users"
  add_foreign_key "messages", "rooms"
  add_foreign_key "messages", "users"
  add_foreign_key "proposes", "rooms"
